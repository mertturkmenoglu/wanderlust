  ...
  return (
    <div>
      <div className="mx-auto my-16 max-w-2xl text-wrap">
        <h1 className="text-2xl font-bold text-center pb-3">Wanderlust - Privacy Policy</h1>
        <div className="mt-2 font-semibold">
          Effective Date: June 13, 2024
        </div>
        <p className="mt-4">
          Welcome to Wanderlust! This Privacy Policy explains how Wanderlust ("we" or
          "us") collects, uses, shares, and protects information in relation to
          the Wanderlust mobile application and its services (the "Service"). By
