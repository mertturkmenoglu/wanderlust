...
export default function page() {
  return (
    <div className="mx-auto my-16 max-w-2xl text-wrap">
      <h1 className="text-2xl font-bold text-center pb-3">Wanderlust - Terms of Service</h1>
      ...
      <ol className="mt-8 space-y-4">
        ...
        <li>
          ...
          <ol className="ml-4">
            <li>
              ...
              information provided when listing services. Wanderlust reserves the
        ...
        <li>
          ...
          harmful to other users of the Service, to Wanderlust, or to third
          parties.
        </li>
        <li>
        ...
        <li>
          ...
          event shall Wanderlust be liable for any indirect, incidental, special,
      ...
      <p className="mt-8">
        By using the Wanderlust, you agree to these Terms of Service. Thank
