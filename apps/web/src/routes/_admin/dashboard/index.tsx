...
function RouteComponent() {
	return (
		<div>
			...
			<div className="mb-96 grid grid-cols-2 gap-x-8 gap-y-4 md:grid-cols-3">
				...
				<Item href="/dashboard/exports" text="Exports" icon={ArchiveIcon} />

				<Item href="/dashboard/ingest" text="Ingest" icon={ImportIcon} />
			</div>
		</div>
	);
}
