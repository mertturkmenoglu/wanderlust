...
func Authz(key authz.AuthzAct) func(api huma.API) func(ctx huma.Context, next func(huma.Context)) {
	return func(api huma.API) func(ctx huma.Context, next func(huma.Context)) {
