...
type LoginInputBody struct {
	...
	Password string `json:"password" example:"strongpassword123" doc:"Password of the user" minLength:"1" maxLength:"128" required:"true"`
}
...
type RefreshInput struct {
	CookieRefreshToken string `cookie:"refresh_token" doc:"Refresh token of the user"`
}
...
type SendForgotPasswordEmailOutput struct {
}
