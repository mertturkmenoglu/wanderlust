...
import { updateUserProfileImage } from "~/lib/api-requests";
    ...
    <div className="mt-4 max-w-xl flex gap-4">
      <Dialog>
        <DialogTrigger asChild>
          <button className="relative group">
            <img
              src={preview}
              alt={fullName}
              className="mt-4 w-32 rounded-md aspect-square object-cover"
            />
            <div
              className={cn(
        ...
        <DialogContent className="sm:max-w-xl">
          <DialogHeader>
            <DialogTitle>Select a new profile image</DialogTitle>
          </DialogHeader>
          <div className="flex flex-col items-center justify-center space-x-2 text-sm gap-8">
            <div className="flex flex-col items-center gap-4">
              <img
                src={preview}
                alt={fullName}
                className="mt-4 w-48 rounded-md aspect-square object-cover"
              />
            </div>
            <div className="flex flex-col">
              ...
              >
                ...
                {!file ? "Upload a profile image" : "Change selection"}
              </label>
