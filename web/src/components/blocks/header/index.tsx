...
export default function Header({ className, ...props }: Readonly<Props>) {
  ...
  return (
    <header className={cn("max-w-7xl mt-8 flex items-center justify-between mx-auto", className)} {...props}>
      <Link to="/" className="flex items-center gap-4">
        <img src="/logo.png" alt="Wanderlust" className="size-12 min-h-12 min-w-12" />
      </Link>
